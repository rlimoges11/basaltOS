...
return function(el, fg, bg, hc) 
    ...
    function api.printc(msg, c)
        el:setForeground(c)
        el:setText(msg)
        el:setBackground(fg)
    end

    function api.logRandomMessage()
        ...
        elseif logType == 2 then
            ...
            if math.random(2) == 1 then
                ...
                api.printc(severity .. ":", colors.yellow, fg)

            else
                severity = "CRITICAL"
                response = "EVACUATE sector "..sector
                api.printc(severity .. ":", colors.red, fg)

            end
            api.printc("Containment breach Sector "..sector.."!", hc, fg)
        ...
        elseif logType == 5 then
            ...
            api.printc("RESEARCH SUCCESS:", hc, fg)
